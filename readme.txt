...
1.In Diagnostics page, pick all the top cities name & store in a List;                                                                       
2.Display the same For Bangalore city, identify Hospitals that is Open 24/7, has Parking facility with rating more than 3.5; Display the hospital names
